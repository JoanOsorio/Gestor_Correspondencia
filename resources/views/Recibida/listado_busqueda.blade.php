    ...
    <form class="form-group" method="POST" action="/Busqueda_Documentos">
        ...
        <div class="form float-left">
            <select class="form-control" name="medio_entrega">
                <option  disabled="" selected="" class="form-control">--Medio de Entrega--</option>
        ...
        <div class="form float-left">
            <input placeholder="Fecha Doc. dd/mm/aaaa" type="text" class="form-control" name="fecha_documento">
        </div>  
        <div class="form float-left">
            <input placeholder="Fecha Recep. dd/mm/aaa" type="text" class="form-control" name="fecha_recepcion">
        </div> 
        <div class="form float-left">
            <select class="form-control" name="tipo_documento">
                <option disabled="" selected="" class="form-control">--Tipo de Documento--</option>
        ...
        <div class="form float-left">
         ...
         <div class="form float-left">
            <select class="form-control" name="empresa_destinatario">
                <option disabled="" selected="" class="form-control">--Empresa Destin.--</option>
        ...
        <div class="form float-left">
            <select class="form-control" name="tipo_remitente">
                <option disabled="" selected="" class="form-control">--Tipo Remitente.--</option>
            ...
            <table class="table table-bordered table-condensed table-pro">
                <thead>
                    <tr>
                        ...
                        <td> Ultima fecha y hora de actualizacion</td>
                    </tr>
                </thead>
                <tbody>
                    @foreach($c_recibida as $recibida)
                        <tr>
                            <td> <a href="/Recibida/{{$recibida->slug}}">{{$recibida->slug}}</a></td>
                            <td> {{$recibida->cr_codigo}} </td>
                            <td> {{$recibida->medent_nombre}} </td>
                            <td> {{$recibida->cr_fecha_documento}} </td>
                            <td> {{$recibida->cr_fecha_recepcion}} </td>
                            <td> {{$recibida->tipdoc_nombre}} </td>
                            <td> {{$recibida->cr_nombre_destinatario}} </td>
                            <td> {{$recibida->emp_nombre}} </td>
                            <td> {{$recibida->cr_nombre_remitente}} </td>
                            <td> {{$recibida->cr_empresa_remitente}} </td>
                            <td> {{$recibida->tiprem_nombre}} </td>
                            <td> {{$recibida->cr_referencia}} </td>
                            <td> {{$recibida->cr_asunto}} </td>
                            <td> {{$recibida->estdoc_nombre}} </td>
                            <td> {{$recibida->cr_empleado}}</td>
                            <td> {{$recibida->created_at}} </td>
                            <td> {{$recibida->updated_at}}</td>
                        </tr>
                    @endforeach  
                </tbody>
            </table>
